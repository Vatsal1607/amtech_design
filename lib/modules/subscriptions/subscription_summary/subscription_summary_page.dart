...
import 'package:amtech_design/modules/subscriptions/subscription_summary/widgets/subs_summary_shimmer.dart';
...
class _SubscriptionSummaryPageState extends State<SubscriptionSummaryPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Consumer<SubscriptionSummaryProvider>(
        builder: (context, provider, child) => provider.isLoading
            ? const SubsSummaryShimmer()
            : Stack(
                children: [
                  Positioned.fill(
                    child: Column(
                                  ...
                                  Text.rich(
                                    TextSpan(
                                      ...
                                      children: [
                                        ...
                                        TextSpan(
                                          text:
                                              'Until Your Unit Is Fully Utilized.',
                                          style: GoogleFonts.publicSans(
                                            fontSize: 14.sp,
                                            fontWeight: FontWeight.w600,
                                            color: getColorAccountType(
